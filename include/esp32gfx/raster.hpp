...
extern template void fill_triangle_gouraud(SurfaceRGBA32&, int16_t, int16_t, Color, int16_t, int16_t, int16_t, Color, int16_t, int16_t, int16_t, Color, int16_t);
extern template void fill_triangle_gouraud(SurfaceGray8&, int16_t, int16_t, Color, int16_t, int16_t, int16_t, Color, int16_t, int16_t, int16_t, Color, int16_t);
